...
public class Tela5f extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("FESTA DE NOSSA SENHORA DAS MERCÊS");
        ...
        labelTxt.setText("<html><p align=\"justify\">Nossa Senhora das Mercês é a padroeira da Catedral, paróquia mais antiga de Itapipoca, iniciada em Vila Velha-Arapari. Em setembro a comunidade reza com os festejos da padroeira local e também diocesana. É uma festa tradicional que envolve todas as paróquias do município, e toda a sociedade em momento de oração, devoção e encontros fraternos construindo caminhos de esperança no abraço da fé. Os bingos acontecem nos finais de semana perto da festa, com a presença da banda de música municipal</p></html>");
        getContentPane().add(labelTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 450, 180));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5f.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
