...
public class Tela5a extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("<html><center>FESTA DE SÃO SEBASTIÃO PADROEIRO DO MUNICÍPIO</center></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
