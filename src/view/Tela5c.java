...
public class Tela5c extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("FESTA DAS FLORES");
        ...
        labelTxt.setText("<html><p align=\"justify\">Na última semana de maio acontece a tradicional festa das flores, que reuni toda a sociedade do município, das regiões circunvizinhas e da capital(Fortaleza).Outra ação inovadora realizada\nPela SECUTUDE,foi Festival das Flores, transformado em evento âncora, evento representativo do município agregou valores turísticos e culturais a uma das festas mais tradicionais de Itapipoca, com a realização de feiras, exposições, cursos, desfiles, palestras e etc.</p></html>");
        getContentPane().add(labelTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 450, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5c.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
