...
public class Tela5g extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("REGATA DA PRAIA DA BALEIA");
        getContentPane().add(labelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 450, 80));

        labelTxt.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        labelTxt.setForeground(new java.awt.Color(255, 255, 255));
        labelTxt.setText("<html><p align=\"justify\">Itapipoca foi favorecida pela natureza ao possuir três climas (praia, serra, sertão), possui também, uma das mais lindas praias do litoral cearense. Na praia da Baleia, acontece a tradicional regata, festa que oferece prêmios aos melhores navegantes com troféus e valores em dinheiro, e aos visitantes um lindo espetáculo ao ar livre, de cores nas águas cristalinas de um mar puro e manso. Além de comidas típicas nas pousadas da orla marítima, oferece dunas virgens para caminhadas matinais e passeios de bugre</p></html>");
        getContentPane().add(labelTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 450, 160));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5g.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
