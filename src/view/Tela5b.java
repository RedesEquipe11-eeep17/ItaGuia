...
public class Tela5b extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5b.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
