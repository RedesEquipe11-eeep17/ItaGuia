...
public class Tela4c extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("Igreja da matriz");
        painel.add(labelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 450, 42));

        labelTxt.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        labelTxt.setForeground(new java.awt.Color(255, 255, 255));
        labelTxt.setText("<html><p align=\"justify\">Entenda os primórdios da terra dos três climas. O berço do centro da cidade é a igreja da matriz (Nossa Senhora das Mercês) construída por Frei Cassiano (1887-1890) com a ajuda de Monsenhor Antero de Lima e Caio Prado (então governador  da província). A igreja guarda em sua arquitetura  traços da belle époque, trazida da França no  período parnasianista. A edificação caracteriza-se por marcar o início do povoamento do centro da cidade.</p></html>");
        painel.add(labelTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 71, 450, 193));
        ...
        painel.add(botaoReturn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 282, 100, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela4c.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
