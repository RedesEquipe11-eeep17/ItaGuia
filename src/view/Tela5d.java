...
public class Tela5d extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("EXPOSIÇÃO AGROPECUARIA");
        getContentPane().add(labelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 450, 60));

        labelTxt.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        labelTxt.setForeground(new java.awt.Color(255, 255, 255));
        labelTxt.setText("<html><p align=\"justify\">Evento que antecede as comemorações alusivas ao aniversário do município. Feira agropecuária, com estandes variados que mostram o que há de mais atual no setor agropecuário. Este grande acontecimento que movimenta as dependências do Parque de Exposições Coronel Hildeberto Barroso,conta também com apresentações culturais, festas dançantes com grandes atrações, quiosques para a venda de bebidas e comidas, grande estacionamento, exposição de animais e muita diversão</p></html>");
        getContentPane().add(labelTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 430, 190));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela5d.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
